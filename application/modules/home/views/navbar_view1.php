  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="<?php echo base_url(). ''?>">Home</a></li>
        ...
        <li><a href="<?php echo base_url(). 'Portfolio/portfolio'?>">Portfolio</a></li>
...
<div class="navbar-fixed">
  ...
  <div class="nav-wrapper">
    ...
    <ul class="right hide-on-med-and-down">
      <li><a href="#">Home</a></li>
      <li><a class="dropdown-button" href="#!" data-activates="main_nav">Photo Gallery</a></li>
      <li><a href="#">About Indesign</a></li>
      <li><a href="#">Services</a></li>
      <li><a href="#">Portfolio</a></li>
      <li><a class="dropdown-button" data-activates="account-drop" href="#!"><i class="perm_identity left"></i>My Account</a></li>
...
<ul id="main_nav" class="dropdown-content">
  <li><a href="#!">one</a></li>
  <li><a href="#!">two</a></li>
  <li class="divider"></li>
...
<ul id="account-drop" class="dropdown-content">
